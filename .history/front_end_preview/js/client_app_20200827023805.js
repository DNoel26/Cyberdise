...
const App =
{
    init()
    {
        ...
        const special_div = document.querySelector("#go_to_top");
        ...
        document.addEventListener("DOMContentLoaded",()=>{
            ...
            //home_page_html.style.overflow = "auto";
            rating_div.innerHTML = Rating_Widget.tag;
            doc_body.appendChild(rating_div);
            
            
            doc_body.appendChild(Rating_Widget.append_widget(rating_div));
        })
    }
}
